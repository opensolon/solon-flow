...
public class DemoController {
    ...
    public ModelAndView displayFlow(Context ctx, String instanceId, String chainId) throws Throwable {
        ...
        //获取展示节点及装态
        StatefulTask task = flowEngine.stateful().getTask(chainId, context);// if null: 界面显示只读; no null: 界面显示操作：同意，拒绝，撤回到上一节点，撤回到起始节点（给发起人）
        return null;
    }
    ...
    public void postFlow(Context ctx, String instanceId, String chainId, String nodeId, int operation) throws Throwable {
        ...
        flowEngine.stateful().postOperation(context, chainId, nodeId, StateOperation.codeOf(operation));
    }
}