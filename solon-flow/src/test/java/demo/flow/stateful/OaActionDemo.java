...
public class OaActionDemo {
    ...
    public void case1() throws Exception {
        ...
        context.put("actor", "A");
        StatefulTask task = flowEngine.stateful().getTask(chainId, context);

        //展示界面，操作。然后：

        context.put("op", "审批");//作为状态的一部分
        flowEngine.stateful().postOperation(context, task.getNode(), StateOperation.FORWARD);
    }
    ...
    public void case2() throws Exception {
        ...
        flowEngine.stateful().postOperation(context, task.getNode(), StateOperation.BACK);
    }
    ...
    public void case3_2() throws Exception {
        ...
        while (true) {
            StatefulTask statefulNode = flowEngine.stateful().getTask(chainId, context);
            context.put("op", "任意转跳");//作为状态的一部分
            flowEngine.stateful().postOperation(context, statefulNode.getNode(), StateOperation.BACK);
    ...
    public void case7() throws Exception {
        ...
        flowEngine.stateful().postOperation(context, task.getNode(), StateOperation.RESTART);
    }
    ...
    public void case9() throws Exception {
        ...
        flowEngine.stateful().postOperation(context, task.getNode(), StateOperation.TERMINATED);
    }

    //抄送
    public void case10() throws Exception {
        FlowContext context = new FlowContext(instanceId);
        StatefulTask node = flowEngine.stateful().getTask(chainId, context);

        flowEngine.stateful().postOperation(context, node.getNode(), StateOperation.FORWARD);
