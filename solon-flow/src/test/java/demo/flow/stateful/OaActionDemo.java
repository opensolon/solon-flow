...
public class OaActionDemo {
    ...
    public void case1() throws Exception {
        ...
        statefulService.postOperation(context, task.getNode(), StateOperation.FORWARD);
    }
    ...
    public void case2() throws Exception {
        ...
        statefulService.postOperation(context, task.getNode(), StateOperation.BACK);
    }
    ...
    public void case3_2() throws Exception {
        ...
        while (true) {
            ...
            context.put("op", "任意转跳");//作为状态的一部分
            statefulService.postOperation(context, statefulNode.getNode(), StateOperation.BACK);
    ...
    public void case7() throws Exception {
        ...
        statefulService.postOperation(context, task.getNode(), StateOperation.RESTART);
    }
    ...
    public void case9() throws Exception {
        ...
        statefulService.postOperation(context, task.getNode(), StateOperation.TERMINATED);
    }
    ...
    public void case10() throws Exception {
        ...
        statefulService.postOperation(context, node.getNode(), StateOperation.FORWARD);
